          ...
          <el-collapse v-model="activeNames" class="widget-collapse">
            ...
            >
              ...
              >
                ...
                >
                  <span>
                    <svg-icon :icon-class="fld.icon" />BBB{{
                      i18n2t(
                        `designer.widgetLabel.${fld.type}`,
                        `extension.widgetLabel.${fld.type}`
                      )
            ...
            <el-collapse-item
              name="5"
              :title="i18nt('designer.customFieldTitleJia')"
            >
              <draggable
                tag="ul"
                :list="customjiaFields"
                :group="{ name: 'dragGroup', pull: 'clone', put: false }"
                :move="checkFieldMove"
                :clone="handleFieldWidgetClone"
                ghost-class="ghost"
              ...
              >
                <li
                  v-for="(fld, index) in customjiaFields"
                  :key="index"
                  class="field-widget-item"
                  :title="fld.displayName"
                  @dblclick="addFieldByDbClick(fld)"
...
export default {
  ...
  methods: {
    ...
    loadWidgets() {
      ...
      this.customjiaFields = this.customjiaFields
        .map((fld) => {
          return {
            ...fld,
            displayName: this.i18n2t(
