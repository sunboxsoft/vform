...
import { alertSchema, alertjiaSchema } from "@/extension/samples/extension-schema";
import AlertWidget from "@/extension/samples/alert/alert-widget";
import AlertjiaWidget from "@/extension/samples/alertjia/alertjia-widget";
...
export const loadExtension = function() {
    ...
    addCustomjiaWidgetSchema(alertjiaSchema); //加载组件Json Schema
    /* -------------------------------------------------- */
    Vue.component(AlertWidget.name, AlertWidget); //注册组件
    Vue.component(AlertjiaWidget.name, AlertjiaWidget) //注册组件
        /* -------------------------------------------------- */
    PERegister.registerCPEditor(
        "alert-title",
        "alert-title-editor",
    ...
    PERegister.registerCPEditor(
        ...
        PEFactory.createRadioButtonGroupEditor(
            "effect",
            "extension.setting.effect", { optionItems: effectOptions }
        )
    );
